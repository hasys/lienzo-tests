...
public final class SettingsBuilder {
    ...
    public static com.ait.lienzo.test.settings.Settings build( Settings settingsAnnotation,
                                                               ...
                                                               Translators translatorAnnotation,
                                                               Class prepareForTest) throws Exception {
        ...
        if (null != prepareForTest ) {
            addPreparations(prepareForTest, result);
        }
    ...
    private static void addPreparations(AnnotatedElement clazz, com.ait.lienzo.test.settings.Settings settings) {
        PrepareForTest p = clazz.getAnnotation(PrepareForTest.class);

        for (Class cl : p.value()) {
            settings.getPowerMockPreparations().add(cl.getName());
        }
    }
